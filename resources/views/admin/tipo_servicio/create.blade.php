...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card card-warning">
            ...
            <div class="card-body">
                {!! Form::open(['route' => 'tipo_servicio.store', 'method' => 'post', 'enctype' =>
                'multipart/form-data']) !!}
                <fieldset>
                    <div class="form-group row">
                        <label for="tipo" class="col-md-4 col-form-label text-md-right">Tipo de Servicio</label>
                        <div class="col-md-6">
                            {!! Form::text('tipos[]', null, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>

                    <div id="camposTipoContainer">
                        <!-- Contenedor para campos de tipo de servicio -->
                    </div>
                        ...
                        <div class="col-md-6 offset-md-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="agregarTipo">
                                    ¿Desea agregar otro tipo de servicio?
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    function agregarCampoTipo() {
                        ...
                        // Crear campo de tipo de servicio utilizando Laravel Collective
                        var tipoField = document.createElement('div');
                        tipoField.classList.add('form-group', 'row');
                        tipoField.innerHTML = `
                    <label class="col-md-4 col-form-label text-md-right">Tipo de Servicio</label>
                    <div class="col-md-6">
                        {!! Form::text('tipos[]', null, ['class' => 'form-control', 'required']) !!}
                    </div>
                    <div class="col-md-2">
