            ...
            <div class="card card-danger">
                <div class="card-header d-flex">
                    ...
                    <div>
                        ...
                        <br>
                        <h8 class="card-text">Usted está eliminando un nombre de la tabla "Nombres de servicios".</h8>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-12">
                            ...
                            <fieldset>
                                <div class="form-group row">
                                    <label for="marca" class="col-md-4 col-form-label text-md-right">Nombre del servicio</label>
                                    <div class="col-md-6">
