...
<div class="card">
    ...
    <input type="text" name="nombreCompleto" class="form-control" maxlength="100" id="nombreCompleto" oninput="formatNameInput(this)">
...
<input type="text" name="telefono" class="form-control" id="telefono" pattern="[0-9]{0,10}" onkeypress="return isNumberKey(event)" oninput="truncatePhoneNumber(this)">
@error('telefono')
    <span class="text-danger">{{ $message }}</span>
@enderror
</div>
...
<div class="form-group">
    ...
    <input type="text" name="correo" class="form-control" maxlength="30" id="correo" oninput="validateEmail(this)" >
        @error('correo')
            <span class="text-danger">{{ $message }}</span>
        @enderror
</div>
